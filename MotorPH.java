...
public class MotorPH extends JFrame {
    ...
    private void initializeUI() {
        ...
        JLabel userLabel = new JLabel("Logged in as: " + authService.getCurrentUser().getUsername());
        ...
        JButton singleEmployeeButton = new JButton("Compute Payroll for a Specific Employee");
        JButton allEmployeesButton = new JButton("Compute Payroll for All Employees");

        singleEmployeeButton.addActionListener(e -> handleSingleEmployee());
        allEmployeesButton.addActionListener(e -> handleAllEmployees());

        contentPanel.add(singleEmployeeButton);
        contentPanel.add(allEmployeesButton);
    ...
    private void handleSingleEmployee() {
        SwingUtilities.invokeLater(() -> {
            SpecificEmployeeFrame specificEmployeeFrame = new SpecificEmployeeFrame();
            specificEmployeeFrame.setVisible(true);
            this.dispose();
        });
    }

    private void handleAllEmployees() {
        processPayrollForAllEmployees("src/main/employeedata.csv", "src/main/attendancerecord.csv");
    }
